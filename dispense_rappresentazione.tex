...
\begin{rem}
	Dato $G$ un gruppo, $H<G$, non è difficile mostrare che tutte le classi laterali di $H$ in $G$ hanno la stessa cardinalità.
\end{rem}
...
\begin{rem} Notare che il teorema precedente è falso per gruppi infiniti. (Esempio con $\mathbb{Z}^+$ che Salvatore non ha scritto con cura. Porco salvatore)

  QUALCUNO SCRIVA L'ESEMPIO
\end{rem}
