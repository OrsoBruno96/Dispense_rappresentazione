...
Questo metodo è particolarmente potente perché, per ogni rappresentazione $\sigma:G\to GL(\C)$, l'immagine è un gruppo abeliano, quindi, in virtù del primo teorema di omomorfismo, l'immagine di una qualsiasi rappresentazione $\sigma$ di grado 1 è un quoziente abeliano di $G$.
...
Ora basta osservare che $\imath_{V_\rho} \circ [\rho(g^{-1})] = [(\rho+\sigma)(g^{-1})] \circ \imath_{V_\rho}$
e in modo del tutto analogo $\imath_{V_\sigma} \circ [\sigma(g^{-1})] = [(\rho+\sigma)(g^{-1})] \circ \imath_{V_\sigma}$,
da cui la tesi.

Notiamo anche che l'isomorfismo è canonico, ovvero non dipende dal fatto di poter scegliere delle basi.
\end{proof}
