...
\subsection{Serie di composizione}
	...
	\begin{proof}
		...
		\begin{gather*}
			...
			0=V'_0\subseteq\ldots \subseteq V'_m = V\qquad W'_i=V'_i/V'_{i-1}
		\end{gather*}
	...
	\end{proof}
	\begin{exmp}
		Sia $A=\K[G]$ con $\Char \K \not | ord(G)$, allora ogni rappresentazione di dimensione dinita è somma di moduli irriducibili. I fattori di composizione coincidono con gli addendi irriducibili contati con molteplicità.
	\end{exmp}
	\begin{rem}
	...
	\end{proof}
	\begin{prop}
		Sia $V$ un $A$-modulo indecomponibile e $\phi\in \End_A(V)$, allora $\phi$ è un isomorfismo oppre è nilpotente.
	\end{prop}
	\begin{proof}
