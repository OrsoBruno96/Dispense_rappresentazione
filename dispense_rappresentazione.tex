...
Questo metodo è particolarmente potente perchè, per ogni rappresentazione $\rho:G\to GL(\C)$, l'immagine è un gruppo abeliano, quindi, in virtù del primo teorema di omomorfismo\eqref{alg:primo_teo_omo}, l'immagine di una qualsiasi rappresentazione $\rho$ di grado 1 è un quoziente abeliano di $G$.
