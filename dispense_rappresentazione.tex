...
\begin{rem}
Supponiamo che $\rho:G\to GL(V)$ sia una rappresentazione irriducibile. Allora il fatto che esiste una forma bilineare $G-$invariante
...
\begin{lemma}
Sia $V$ una $G-$rappresentazione $/\C$. Allora ogni forma bilineare non nulla $G-$invariante è non degenere. Inoltre, se esiste, è unica a meno di scalari, ovvero $\dim (V^*\otimes V^*)^G\le1$.
\end{lemma}
\begin{proof}
...
\begin{thm}
Sia $\rho:G\to GL(V_\rho)$ una rappresentazione $/\C$. Definiamo 
$m_\rho = \dfrac{1}{|G|} \dsum_{g \in G} \chi_{\rho}(g^2)$
 detto ``indicatore di Frobenius-Schur''. Allora
\begin{enumerate}
...
Supponiamo ora $\dim W = 1$, dunque $W$ è rappresentazione irriducibile di $G$.
