...
\[ \forall\ a\in G, \forall\ v\in V_{\rho}\quad \varphi(a\cdot_\rho v) = a\cdot\sigma \varphi(v) \]
...
\[ V_{\rho^* \sigma} = V_{\rho}^* \otimes V_\sigma \iso \Hom(V_\rho, V_\sigma)\]
dove l'isomorfismo di rappresentazioni è quello dimostrato nel teorema \ref{thm: isov*w}.
In particolare abbiamo che
\[ (V_{\rho^*\sigma})^G \iso \Hom(V_\rho, V_\sigma)^G \iso \Hom(\rho, \sigma)\]
...
\begin{rem}
  ...
  \item Se $\rho$ e $\sigma$ sono 2 rappresentazioni irriducibili allora $$\rho \iso \sigma \Leftrightarrow \chi_{\rho}=\chi_{\sigma}$$
...
\end{lemma}
\begin{proof} Abbiamo visto prima che $(V^*\otimes V^*)^G\neq 0\Rightarrow \chi_\rho=\chi_{\rho^*}\Rightarrow \chi_\rho$ è reale, e se $\rho$ è reale o quaternionica ha proprio $(V^*\otimes V^*)^G$ diverso da $0$. Viceversa $\chi_\rho$ reale implica $\chi_\rho=\chi_{\rho^*}$. D'altra parte dato che $\rho$ e $\rho^*$ sono entrambe rappresentazioni irriducibili allora $\rho\iso\rho^*\Leftrightarrow \chi_\rho =\chi_{\rho^*}$. Ciò significa che $\Hom_G(V,V^*)\neq 0\Rightarrow \exists B\in (V^*\otimes V^*)^G\Rightarrow \rho$ può essere solo reale o quaternionica.
\end{proof}
...
\end{thm}
\begin{proof} sia $\phi:W\rightarrow \Res_H^G(U)$ un omomorfismo di $H-$rappresentazione e sia $V:=\Ind_H^G(W)=\bigoplus_{i=1}^{\#-orbite} \rho_{ind}(g_i)V_{eH}$. Essendo $V_{eH}\iso W$ come $H-$rappresentazioni, allora $\phi:V_{eH}\rightarrow \Res_H^G(U)$: voglio estenderlo a $V$. Essendo $V$ definito come una somma diretta è sufficiente definire l'omomorfismo sui blocchi e per questo considero $V_{g_iH}$: ho che
