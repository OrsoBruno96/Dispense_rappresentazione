...
\subsection{Prime definizioni e esempi}
	...
	\begin{exmp} Alcuni esempi di algebre sono:
		\begin{enumerate}
			...
			\item $\K<x_1,\ldots,x_n>$ è l'algebra libera, sono le parole nell'alfabeto $\{x_1,\ldots,x_n\}$, il prodotto è la concatenazione; è generata da $x_{i_1}\cdots x_{i_k}$ (simile come costruzione al gruppo libero su $n$ generatori)
