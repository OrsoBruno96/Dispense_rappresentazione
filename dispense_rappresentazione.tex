...
Definiamo a questo punto un endomorfismo $\phi: V_\rho \to V_\rho$ imponendo che soddisfi $B(x, y) = h(\phi(x), y)$.
...
E quindi purtroppo $\phi$ non è davvero lineare. Vediamo però che $\phi^2$ si comporta meglio:
